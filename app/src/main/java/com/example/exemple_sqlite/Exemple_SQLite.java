/*
Electif BASES DE DONNEES AVANCEES & APPLICATIONS MOBILES
Utilisation d'une Base de Données SQLite
Amadou COULIBALY 23/20//4/2021
*/
...
public class Exemple_SQLite extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Livre livre = new Livre("12345", "Electif_BDA & AM");
